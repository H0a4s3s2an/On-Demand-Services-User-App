...
import com.example.sample.usertribe.Helper.PlacesAutoCompleteAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pickerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    builder = new PlacePicker.IntentBuilder();
                    Intent intent = builder.build(AutoCompleteSearch.this);
                    // Start the Intent by requesting a result, identified by a request code.
                    startActivityForResult(intent, PLACE_PICKER_FLAG);

                } catch (GooglePlayServicesRepairableException e) {
                    GooglePlayServicesUtil
                            .getErrorDialog(e.getConnectionStatusCode(), AutoCompleteSearch.this, 0);
                } catch (GooglePlayServicesNotAvailableException e) {
                    Toast.makeText(AutoCompleteSearch.this, "Google Play Services is not available.",
                            Toast.LENGTH_LONG)
                            .show();
                }
            }
